...
#define port_USARTx_busy_sending()	   (HAL_UART_GetState((UART_HandleTypeDef *)(&USARTx)) & HAL_UART_STATE_BUSY_TX != 0)
#define port_USARTx_no_data()		       (HAL_UART_GetState((UART_HandleTypeDef *)(&USARTx)) & HAL_UART_STATE_READY != 0)

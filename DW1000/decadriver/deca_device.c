...
int dwt_initialise(uint16 config)
{
    ...
    _dwt_enableclocks(FORCE_SYS_XTI); // NOTE: set system clock to XTI - this is necessary to make sure the values read by _dwt_otpread are reliable    对OTP进行读写操作需将系统时钟设置为XTI
 ...
 * no return value
 */
void dwt_configure(dwt_config_t *config)   //参数配置
{
